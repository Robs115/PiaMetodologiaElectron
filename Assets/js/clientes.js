...
function renderTabla(lista) {
    ...
    if (lista.length === 0) {
        ...
        fila.innerHTML = `<td colspan="6" style="text-align: center;">No hay clientes registrados</td>`;
...
window.editarCliente = async (id) => {
    try {
        ...
        console.error('Error:', error);
        mostrarNotificacion('Error al editar cliente', 'error');
    }
};
...
window.eliminarCliente = async (id) => {
    ...
    try {
        ...
        mostrarNotificacion(resultado.message || 'Cliente eliminado correctamente', 'success');
